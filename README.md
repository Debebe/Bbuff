...
with inflated cost - `gdp_inc_le_cost.rds`
 ...
 - The overall model outputs are generated by running`panalysis.R`. It works with the final data - `gdp_inc_le_cost.rds`
...
The meta-analysis and the forest plots can be executed by `meta_analysis.R` script. It runs 1). meta-analysis on RR of TBM, 2). Sequalae of TBM
